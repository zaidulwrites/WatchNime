...
const LicensePage: React.FC = () => {
  ...
  if (!context) {
    return <div className="text-red-500 text-center mt-10">App context not available.</div>;
  }
    ...
    <div className="min-h-screen bg-gray-900 text-white p-6 md:p-8">
      <div className="container mx-auto bg-gray-800 p-6 rounded-lg shadow-lg max-w-4xl">
        ...
        <div className="prose prose-invert text-gray-300 max-w-none leading-relaxed">
          <p className="mb-4">
            Watchnime and its services are a non-profit project created purely for educational and personal use.
            We do not promote or support any form of copyright infringement. All anime, videos, and related
            media displayed on this website are the property of their respective copyright holders.
          </p>

          <p className="mb-4">
            We do not host any content on this website. All video streams are embedded from external third-party
            hosting services. We take no responsibility for the content hosted on those platforms.
          </p>
          ...
          <p className="mb-4">
            ...
            regarding the completeness, accuracy, reliability, suitability, or availability of any content on the website.
            Your reliance on any information is strictly at your own risk.
          </p>

          <h3 className="text-xl font-semibold text-orange-400 mt-6 mb-3">Third-Party Links</h3>
          <p className="mb-4">
            Our website may contain links to websites that are not under our control. We are not responsible for the
            content, privacy policies, or practices of any linked sites. You access and use such third-party sites
            entirely at your own risk.
          </p>

          <h3 className="text-xl font-semibold text-orange-400 mt-6 mb-3">Changes to This License</h3>
          <p className="mb-4">
            We reserve the right to update or modify this license agreement at any time. Any changes will become
            effective immediately upon posting on the website. Continued use of the website after any such changes
            will constitute your acceptance of the revised license agreement.
          </p>
